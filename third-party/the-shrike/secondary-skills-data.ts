...
export const SECONDARY_SKILLS_SHRIKE: SecondarySkillsByClass = {
  ...
  { min: 31, max: 40, skill: 'Sailor (Deckhand)', lifestyle: 'Squalid' },
  { min: 41, max: 50, skill: 'Navigator', lifestyle: 'Comfortable' },
  { min: 51, max: 60, skill: 'Scrimshander (Bone Carver)', lifestyle: 'Poor' },
  { min: 61, max: 70, skill: 'Cooper (Barrel Maker)', lifestyle: 'Modest' },
  { min: 71, max: 80, skill: 'Fisherman', lifestyle: 'Squalid' },
  { min: 81, max: 85, skill: 'Ship\'s Cook', lifestyle: 'Poor' },
